  ...
  public:
    ...
    FORCE_INLINE static int16_t degTargetHotend(const uint8_t E_NAME) {
      ...
      static void setTargetHotend(const int16_t celsius, const uint8_t E_NAME) {
        ...
        #endif
        TERN_(AUTO_POWER_CONTROL, if (celsius) powerManager.power_on("setTargetHotend:AUTO_POWER_CONTROL"));
      ...
      static void setTargetBed(const int16_t celsius) {
        TERN_(AUTO_POWER_CONTROL, if (celsius) powerManager.power_on("setTargetBed"));
        temp_bed.target =
